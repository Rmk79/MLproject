...
...and generate a confusion matrix on this test data and we can see that it is about 82% accurate here, suggesting an out of sample error rate of around 18%, which is close to the rate estimated during the cross validation.
