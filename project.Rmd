...
modFit
```
From this we can expect an accuracy of around 80% though cross validation tends to over estimate this. This would suggest an out of sample error rate of about 10%.
...
...and generate a confusion matrix on this test data and we can see that it is about 82% accurate here, suggesting an out of sample error rate of around 8%, which is close to the rate estimated during the cross validation.
